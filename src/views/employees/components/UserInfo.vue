<template>
  <div class="user-info" style="position:relative">
    <!-- 把要打印的页面用一个标签包裹起来 定义一个id名字 用v-print=“‘#id名字’” 就可以实现打印
    在mian.js中导入并使用插件 import Print from 'vue-print-nb' Vue.use(Print) 下载依赖包 vue-print-nb -->
...
export default {
  ...
  async created () {
    ...
    this.formData = res1
    console.log('员工详细信息', res1)
  },
  methods: {
    async saveUser () {
      await saveUserInfo(this.id, this.userInfo)
